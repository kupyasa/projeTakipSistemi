<x-app title="Danışman Ekle">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title text-center">Sisteme yeni danışman ekle</h5>
            <form action="{{route('sistemyoneticisi.danismaneklepost')}}" method="POST" enctype="multipart/form-data">
                @csrf               
                <div class="mb-3">
                ...
                <div class="text-end my-4 my-2">
                    <button type="submit" class="btn btn-primary">Danışmanı ekle</button>
                </div>
            </form>
        </div>
    </div>
