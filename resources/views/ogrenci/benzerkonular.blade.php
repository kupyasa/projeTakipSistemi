<x-app title="Benzer Konu Önerilerim">
    <x-slot name="header">
        <h2 class="h4 font-weight-bold">
            {{ __('Benzer Konu Önerilerim') }}
        </h2>
    </x-slot>
    @if ($sisteme_dahil)
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="heading{{ $benzer_konu_onerisi->benzer_konu_id }}">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                ...
                                Önerdiğim Proje Konusu : {{ $benzer_konu_onerisi->yeni_konu_proje_baslik }}
                            </button>
                        </h2>
                        <div id="collapse{{ $benzer_konu_onerisi->benzer_konu_id }}"
                            ...
                            <div class="accordion-body">
                                <h3>Önerdiğim Projenin Konu Bilgileri</h3>
        ...
        @else
            <div class="card">
                <div class="card-body">
                    <p class="text-center">Aktif yıl ve dönemde benzer konu önerisi yapmadınız.</p>
                </div>
            </div>
